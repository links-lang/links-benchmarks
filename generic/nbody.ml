...
let energy bodies =
  ...
  for i = 0 to Array.length bodies - 1 do
    let b = bodies.(i) in
    let e' = 0.5 *. b.mass *. (b.vx *. b.vx +. b.vy *. b.vy +. b.vz *. b.vz) in
    (* print_endline "KE of body:"; *)
...
let print_body : planet -> unit
  ...
  print_endline "Planet:";
  print_endline @@ string_of_float x;
  print_endline @@ string_of_float y;
  print_endline @@ string_of_float z;
  print_endline @@ string_of_float vx;
  print_endline @@ string_of_float vy;
  print_endline @@ string_of_float vz;
  print_newline ()
